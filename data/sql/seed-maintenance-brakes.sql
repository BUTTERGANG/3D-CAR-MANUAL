...
-- Component: Brake Pads (Front) (id=119)
...
-- Component: Brake Pads (Rear) (id=120)
...
-- Component: Brake Rotor (Front Left) (id=111)
...
-- Component: Brake Rotor (Rear Left) (id=113)
...
-- Component: Brake Caliper (Front Left) (id=115)
...
(4, 119, 'dimension', 'Brake Pad Minimum Thickness (Front)', '0.76', 'mm', 'Replace front pads at or below this thickness. Source: charm.li Specifications > Mechanical > Disc Brake System > Brake Pad'),
(4, 120, 'dimension', 'Brake Pad Minimum Thickness (Rear)', '0.76', 'mm', 'Replace rear pads at or below this thickness. Source: charm.li Specifications > Mechanical > Disc Brake System > Brake Pad');

-- Rotor specifications
INSERT INTO specifications (system_id, component_id, spec_type, name, value, unit, notes) VALUES
(4, 111, 'dimension', 'Brake Rotor Maximum Scoring Depth (Front)', '1.50', 'mm', 'Rotor requires refinishing or replacement if scoring exceeds this. Surface: 0.059in'),
(4, 112, 'dimension', 'Brake Rotor Maximum Scoring Depth (Front)', '1.50', 'mm', 'Rotor requires refinishing or replacement if scoring exceeds this. Surface: 0.059in'),
(4, 113, 'dimension', 'Brake Rotor Maximum Scoring Depth (Rear)', '1.50', 'mm', 'Rotor requires refinishing or replacement if scoring exceeds this. Surface: 0.059in'),
(4, 114, 'dimension', 'Brake Rotor Maximum Scoring Depth (Rear)', '1.50', 'mm', 'Rotor requires refinishing or replacement if scoring exceeds this. Surface: 0.059in');

-- Rotor thickness variation
INSERT INTO specifications (system_id, component_id, spec_type, name, value, unit, notes) VALUES
(4, 111, 'dimension', 'Brake Rotor Maximum Thickness Variation', '0.025', 'mm', 'Exceeding this causes brake pulsation. Must be checked before LRO measurement. Source: charm.li'),
(4, 112, 'dimension', 'Brake Rotor Maximum Thickness Variation', '0.025', 'mm', 'Exceeding this causes brake pulsation. Must be checked before LRO measurement. Source: charm.li'),
(4, 113, 'dimension', 'Brake Rotor Maximum Thickness Variation', '0.025', 'mm', 'Exceeding this causes brake pulsation. Source: charm.li'),
(4, 114, 'dimension', 'Brake Rotor Maximum Thickness Variation', '0.025', 'mm', 'Exceeding this causes brake pulsation. Source: charm.li');

-- Fluid specification
INSERT INTO specifications (system_id, component_id, spec_type, name, value, unit, notes) VALUES
(4, 128, 'other', 'Brake Fluid Type', 'DOT 3', 'N/A', 'GM Part No. 88862806 (US) / 88862807 (Canada). Source: charm.li Specifications > Fluid Type > Brake Fluid');
